from game import GameWindow,Chess,is_win
...
class SinglePlayer(GameWindow):
    ...
    def mouseReleaseEvent(self, a0: QtGui.QMouseEvent):
        ...
        yy = (y - 50) // 30
        # 如果此处已经有棋子，点击失效
        if self.chessboard[yy][xx] is not None:
            return

        self.chessboard[yy][xx] = self.chess
        self.history.append((yy, xx))
        print(self.chessboard)
        print('gei',self.history)
